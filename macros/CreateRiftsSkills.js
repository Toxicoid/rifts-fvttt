...
skill("Sniper", "Espionage", "espionage", 0, 0,
  "Special training in long-range shooting and marksmanship.\nBonus: +2 to strike on a Called Shot or Aimed Shot ONLY — it does not apply to ordinary attacks, bursts or pulse attacks.\nUsable weapons: only those that fire a single bullet/round or blast — bows and arrows, crossbows, bolt-action rifles, and energy rifles that can switch from burst/pulse to a single shot. No automatic burst firing.",
  "COMBAT BONUS SKILL — not a percentile roll. Add the +2 to your strike total only when declaring a Called or Aimed Shot with a qualifying single-shot weapon. (Book-verified, p.309.)",
  { requiredOCC: "", requiredLocation: "", requiredSkills: "", selectModifiers: "+2 to strike on a Called or Aimed Shot only; single-shot weapons only.", bonusesText: "" });
...
skill("W.P. Rope", "W.P.", "weaponProficiency", 0, 0,
  "Strike: +1 at levels 1, 4, 8, 12, 15 — cumulative (+5 total by level 15), when the rope/lasso is used in combat or for boarding.\nEntangle: +1 (flat bonus, not level-keyed).\nDisarm: +1 (flat bonus, not level-keyed).\nRope CANNOT be used to parry.\nCowboy & Saddle Tramp O.C.C.s who take BOTH W.P. Rope and the Roping skill: an additional +2 to strike and +2 to disarm when using the lasso against humanoid opponents.\n\nUSES: trip attack (a successful strike knocks the victim down — they lose initiative and one melee attack; a mounted, vehicle-borne or super-strong attacker may drag them). Entangle pins a limb or body part: an entangled arm/hand leaves the victim at half bonuses and -1 attack unless ambidextrous; a lassoed leg means half speed, -4 dodge and roll, -1 parry/disarm/pull. Upper body pins one arm; a second lasso pins both (speed -20%, -2 dodge, no parry, no damage but physically helpless). Multiple lassoes can spread-eagle a target.\nDISARM detail: a successful disarm slips the lasso off the arm and takes whatever was held — 01-60% it falls to the ground, 61-00% it is lassoed and can be pulled to the attacker over two melee actions (three attacks total: one to disarm, two to pull).\nSTRANGLE: roping the neck prevents speech and restricts breathing (-1 attack per melee); tightening it (one melee attack) cuts off air entirely. Dizziness in about two minutes (-2 attacks, -3 combat bonuses), unconsciousness by four, then coma and death. Does NOT work on power armor, Full Conversion Cyborgs or robots; against supernatural beings the attacker needs greater Supernatural Strength.\nESCAPE: cut free with a blade or claws (1D4 melee actions vs an S.D.C. lasso, one action with an M.D. blade or Robotic/Supernatural P.S.), shoot the line free (two attacks), or pull free with P.S. six points higher than the attacker's. Impossible to draw a weapon or free oneself once both arms are pinned or while being dragged.",
  "W.P. — combat bonus progression, NOT a percentile roll. Strike accumulates at the listed levels; entangle and disarm are flat +1 bonuses. Track your totals in the Bonuses field. Restricted: only characters who can select Cowboy skills may take this W.P. The Roping skill is NOT required to use rope as a weapon. (Book-verified, p.306-307.)",
  { requiredOCC: "Characters who can select Cowboy skills", requiredSkills: "None (Roping not required; taking both grants the Cowboy/Saddle Tramp bonus)" });
...
skill("W.P. Targeting", "W.P.", "weaponProficiency", 0, 0,
  "Strike: +1 at levels 1, 3, 7, 10 — cumulative (+4 total by level 10).\nExpertise with thrown and projectile weapons (but not bows and arrows, crossbows, or guns): sling, slingshot, boomerangs, shurikens, throwing knives, throwing sticks, small axes and spears, even siege weapons.\nStacking: characters with both W.P. Targeting and another W.P. for a missile weapon (but not thrown swords, large axes, staves, etc.) get the usual bonuses for that W.P. PLUS the W.P. Targeting bonus.\nCan throw two small items (knives, shurikens, throwing sticks) simultaneously at the same target.\nPenalty: loses all bonuses and rate of fire is HALVED when running and shooting/throwing, flying, riding on horseback, or from a moving vehicle, or otherwise unbalanced.\nTypical Effective Range & Damage per Weapon Type: Bolas 30 ft — 2D4. Blowgun 30 ft — 1D4. Boomerangs 60 ft — 1D6. Brick/Stone 50 ft — 1D6. Dart 30 ft — 1D4. Hand Grenade 100 ft — varies. Javelin 300 ft — 1D6. Net 30 ft — no damage. Sling/Slingshot 80 ft — 1D6. Spear (thrown) 100 ft — 1D6 or 2D6. Throwing Knives & Shurikens 60 ft — 1D6. Throwing Sticks 40 ft — 1D6. Throwing Axes 40 ft — 2D4. Trident 50 ft — 2D8.\nRange increases: +30% with Augmented (Bionic/Juicer/Crazy) P.S., +50% with Robotic P.S., triple with Supernatural P.S. (quadruple if Supernatural P.S. 31+).\nAwkward items (swords, large axes, pole arms, furniture...): average range only 20 ft at -1 to strike; -3 to strike per additional 10 ft beyond 20.\nHeavy items: half maximum carry weight can be thrown 1 ft per point of human P.S. (x2 ft for Augmented, x3 ft for Robotic; Supernatural 17+ throws half carry weight 5 ft per P.S. point). Standard awkward-throw strike penalties apply.\nNo P.S. damage bonus on arrows or thrown weapons unless the O.C.C. specifically says so.",
  "W.P. — combat bonus progression, NOT a percentile roll. Bonuses accumulate at the listed levels; add your current totals to weapon Strike or track them in the Bonuses field. Requires: any one W.P. for a missile weapon (such as a spear). (RUE p.286 — VERIFIED)",
  { });
